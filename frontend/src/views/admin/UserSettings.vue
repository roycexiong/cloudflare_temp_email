...
const { t } = useI18n({
    ...
    messages: {
        en: {
            ...
            enable: 'Enable',
            enableThirdPartyUser: 'Enable Third Party User',
            ...
            maxAddressCount: 'Maximum number of email addresses that can be created',
        },
        zh: {
            save: '保存',
            successTip: '保存成功',
            enable: '启用',
            enableThirdPartyUser: "启用第三方用户",
            enableMailVerify: '启用邮件验证(发送地址必须是系统中能有余额且能正常发送邮件的地址)',
            verifyMailSender: '验证邮件发送地址',
            enableMailAllowList: '启用邮件地址白名单(可手动输入)',
            mailAllowList: '邮件地址白名单',
            maxAddressCount: '可创建最大邮箱地址数量',
        }
    }
});
    ...
    <div class="center">
        <n-card style="max-width: 600px;">
            <n-form :model="userSettings">
                <n-form-item-row :label="t('enableThirdPartyUser')">
